...
if __name__ == "__main__":
    ...
    tls = glob("../autonomous-car/vehicle-detection/just_traffic_light/just_traffic_light/*.png")

    counter = 1
    for tl in tls:
        detected = detect(net, meta, tl)
        ...
        for d in detected:
            ...
            if d[0] == "traffic light":
                ...
                im.save("../autonomous-car/vehicle-detection/lights/{}.png".format(counter))
                counter += 1
                print counter
'''
